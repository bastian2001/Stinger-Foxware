...
void displayLoop() {
	...
	case STATE_SAFE: {
		if (firstRun) {
			...
			SET_DEFAULT_FONT;
			printCentered("Push the joystick outwards and then rotate it half a turn to continue.", SCREEN_WIDTH / 2, 65, SCREEN_WIDTH, 3, YADVANCE_RELAXED, ClipBehavior::PRINT_LAST_LINE_CENTERED);
		}
	} break;
