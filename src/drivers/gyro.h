...
enum class GyroReg : u8 {
	...
	FEAT_PAGE = 0x2F,
	FEATURES = 0x30,
	ANYMO_1 = 0x3C, // page 1 (0 indexed)
	ANYMO_2 = 0x3E, // page 1 (0 indexed)
	NOMO_1 = 0x30, // page 2 (0 indexed)
	NOMO_2 = 0x32, // page 2 (0 indexed)
	SIGMO_1 = 0x34, // page 2 (0 indexed)
	SIGMO_2 = 0x3E, // page 2 (0 indexed)
	ACC_CONF = 0x40,
	ACC_RANGE = 0x41,
	GYR_CONF = 0x42,
	GYR_RANGE = 0x43,
...
extern i32 bmiDataRaw[6]; // raw data from the BMI160 after calibration
extern i32 *gyroDataRaw; // raw gyro data from the BMI160 after calibration, part of bmiDataRaw
extern i32 *accelDataRaw; // raw accelerometer data from the BMI160 after calibration, part of bmiDataRaw
